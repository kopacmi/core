...
class CacheTest extends TestCase {
	...
	public function testFolderContentsFilter() {
		...
		$this->cache->put($file1, ['size' => 25, 'mtime' => 10, 'mimetype' => 'file1']);

		$this->cache->put($folder, ['size' => 0, 'mtime' => 15, 'mimetype' => 'httpd/unix-directory']);

		$this->cache->put($file2, ['size' => 1000, 'mtime' => 20, 'mimetype' => 'file2']);
		$this->cache->put($file3, ['size' => 20, 'mtime' => 25, 'mimetype' => 'file3']);
